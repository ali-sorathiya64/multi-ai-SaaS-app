 ...
 setLoading(false);
  ...
  return !loading ? (
    <div className='flex-1 h-full flex flex-col gap-4 p-6'>
      <div className='text-2xl  items-center font-bold bg-clip-text text-black '>
    Creations
  </div>
  ...
  {creations.map((creation , index)=>(
    <div key={index} className='relative group inline-block pl-3 pt-3 w-full sm:max-w-1/2 lg:max-w-1/3'>
      <img src={creation.content} alt="creation_image" className='w-full h-full object-cover rounded-lg' />
