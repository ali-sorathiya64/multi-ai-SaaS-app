...
const AITools = () => {
    ...
    return (
        <div className='px-4 sm:px-20 xl:px-32 my-24'>
            <div className='text-center'>
                ...
                <p>Everything you need to create, enhance, and optimize your content
    ...
    hover:translate-y-1 transform-all duration-300 cursor-pointer" onClick={(() => user && navigate(tool.path)
