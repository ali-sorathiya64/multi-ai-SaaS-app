...
const Hero = () => {
  ...
  return (
    ...
    active:scale-95 transition cursor-pointer" >Start Creating Now</button>
     ...
     border-gray-300 hower:scale-102 active:scale-95 transition cursor-pointer ">Watch demo</button>
      </div>


<div className='flex items-center gap-4 mt-8 mx-auto text-gray-600'>
  <img  className="h-8" src={assets.user_group} alt="users" />Trusted by many People
</div>
    </div>
  )
}
